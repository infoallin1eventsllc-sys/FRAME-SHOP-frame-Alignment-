...
export function BillingPage() {
  const { invoices, customers, getCustomerById, addInvoice, updateInvoice } = useApp();
            ...
            {filtered.map((inv, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-zinc-400">{inv.projectId}</td>
