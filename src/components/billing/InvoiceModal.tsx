      ...
      <div className="p-6 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select className={selectCls} value={form.status} onChange={e => field('status', e.target.value as InvoiceStatus)}>
        ...
        <div>
          ...
          <select className={selectCls} value={form.customerId} onChange={e => field('customerId', e.target.value)}>
        ...
        <div>
          ...
          <select className={selectCls} value={form.projectId} onChange={e => field('projectId', e.target.value)}>
