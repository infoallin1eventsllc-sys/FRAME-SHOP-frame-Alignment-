...
export function CustomersPage() {
  const { customers, projects, invoices, addCustomer, updateCustomer } = useApp();
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1.5 text-xs text-zinc-500">
                  ...
                  <div className="flex items-center gap-2">
                    <Car className="w-3 h-3 flex-none" />
                    <span className="truncate">{cust.vehicle}</span>
                  </div>
                </div>
