...
export const RakeTrailCalculator: React.FC = () => {
  ...
  const getStabilityRating = (trailIn: number) => {
    if (trailIn < 3.0) {
      ...
      return {
        ...
        color: 'text-orange-400 bg-white border-orange-600',
      ...
      return {
        ...
        color: 'text-orange-500 bg-white border-orange-600',
  ...
  return (
    <section id="calculator" className="py-24 bg-white border-t border-zinc-200 font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-zinc-50 border border-zinc-200 rounded-none p-6 sm:p-8 space-y-6 shadow-xl">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full accent-orange-600 bg-white h-2 rounded-none cursor-pointer"
              />
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-sm">
                <label className="font-bold text-zinc-800 uppercase text-xs tracking-wider">Raked Triple Trees (Added Degrees)</label>
                  ...
                  <button
                    ...
                    className={`py-2 rounded-none text-xs font-black uppercase tracking-widest transition-all cursor-pointer ${
                      tripleTreeRake === deg
                        ...
                        : 'bg-white text-zinc-600 border border-zinc-200 hover:text-white'
                    }`}
                  >
                    +{deg}° Rake
                  </button>
            ...
            <div className="pt-4 border-t border-zinc-200">
              <span className="text-xs text-zinc-600 font-black uppercase tracking-wider block mb-2">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="text-xs bg-white hover:bg-zinc-100 text-zinc-700 font-bold uppercase px-3 py-1.5 rounded-none border border-zinc-200"
                >
                  Stock FXR / Dyna
                </button>
                <button
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-zinc-50 border border-zinc-200 rounded-none p-6 sm:p-8 shadow-xl space-y-6">
              ...
              {/* Main Gauge Numbers */}
              <div className="bg-white p-6 rounded-none border border-zinc-200 text-center space-y-1">
                <div className="text-xs text-zinc-500 uppercase font-bold tracking-widest">Calculated Trail</div>
                <div className="text-5xl font-black text-zinc-900 font-mono tracking-tight my-1 italic">
              ...
              {/* Technical Breakdown */}
              <div className="space-y-2 text-xs text-zinc-600 bg-white p-4 rounded-none border border-zinc-200">
                <div className="flex justify-between py-1 border-b border-zinc-200">
                  <span className="uppercase font-bold">Total Rake Angle:</span>
                  <span className="font-mono font-bold text-zinc-900">{rakeDegrees + tripleTreeRake}°</span>
                </div>
                <div className="flex justify-between py-1 border-b border-zinc-200">
                  <span className="uppercase font-bold">Tire Radius:</span>
                  <span className="font-mono font-bold text-zinc-900">{tireRadius.toFixed(2)}"</span>
                </div>
                <div className="flex justify-between py-1">
                  <span className="uppercase font-bold">Triple Tree Offset:</span>
                  <span className="font-mono font-bold text-zinc-900">{tripleTreeOffset.toFixed(2)}"</span>
                </div>
              </div>
